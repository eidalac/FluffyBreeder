...
Genome.prototype.getNewGeneColor = function(index, addition) {
	...
	hexOne = Number(Number(hexOne) * 1.25).toFixed(0);
	hexTwo = Number(Number(hexTwo) * 1.25).toFixed(0);
	hexThree = Number(Number(hexThree) * 1.25).toFixed(0);
	...
	if (oFactor === "oO")
	{
		...
		hexThree = Number(Number(hexThree) - Number(Number(Number(hexThree) - Number(48)) / Number(3)).toFixed(0));
	}
	else if (oFactor === "oo")
	{
		...
		hexThree = Number(Number(hexThree) - Number(Number(Number(hexThree) - Number(48)) / Number(4.5)).toFixed(0));
	}
